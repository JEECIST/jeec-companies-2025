<template>
  <section>
    ...
    <div class="buttons">
      <a v-if="$i18n.locale === 'pt'" href="/magazines/JEEC25_Revista_Apresentação.pdf" download>{{ $t("landing-section.buttons.magazine") }}</a>
      <a v-else-if="$i18n.locale === 'en'" href="/magazines/JEEC25_Apresentation_Magazine.pdf" download>{{ $t("landing-section.buttons.magazine") }}</a>
